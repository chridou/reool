...
impl PoolInstrumentation {
    ...
    pub fn connection_dropped(&self, flight_time: Duration, lifetime: Duration) {
        self.flavour
    ...
    pub fn connection_killed(&self, lifetime: Duration) {
        self.flavour.connection_killed(lifetime, self.pool_index)
    }
